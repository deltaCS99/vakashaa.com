    ...
    <div className="min-h-screen bg-gray-50/50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Review and manage tour operator applications</p>
        </div>
        ...
        {/* Operators Table */}
        <OperatorsTable operators={operators} totalPages={totalPages} currentPage={currentPage} />
      </div>
    </div>
  );
}