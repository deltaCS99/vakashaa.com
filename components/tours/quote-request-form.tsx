...
// Success content component moved outside
const SuccessContent = ({ quoteReference }: { quoteReference: string }) => (
            ...
            <div className="hidden md:block">
                <Dialog open={openDesktop} onOpenChange={handleOpenChangeDesktop}>
                    ...
                    <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        {isSuccess ? (
                            <SuccessContent quoteReference={quoteReference} />
                        ) : (
                            <>
                                <DialogHeader>
                        ...
                        {isSuccess ? (
                            ...
                            <>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    {/* Date Selection */}
                                    <div className="space-y-2">
                                        <Label htmlFor="date-mobile" className="flex items-center gap-2">
                                            <Calendar className="w-4 h-4" />
                                            Preferred Date *
                                        </Label>
                                        {tour.availableDates.length > 0 ? (
                                            <Select value={preferredDate} onValueChange={setPreferredDate} required>
                                                <SelectTrigger id="date-mobile">
                                                    <SelectValue placeholder="Choose your preferred date" />
                                                </SelectTrigger>
                                                <SelectContent>
                                                    {tour.availableDates.map((date) => (
                                        ...
                                        <div className="flex items-center space-x-2 mt-2">
                                            <Checkbox
                                                id="flexible-dates-mobile"
                                                checked={flexibleDates}
                                                onCheckedChange={(checked) => setFlexibleDates(checked as boolean)}
                                            />
                                            <Label
                                                htmlFor="flexible-dates-mobile"
                                                className="text-sm font-normal cursor-pointer"
                                            >
                                                My dates are flexible
                                            </Label>
                                    ...
                                    {/* Budget Range */}
                                    <div className="space-y-2">
                                        <Label htmlFor="budget-mobile">Budget Range (Optional)</Label>
                                        <Select value={budgetRange} onValueChange={setBudgetRange}>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <Checkbox
                                                id="whatsapp-same-mobile"
                                                checked={whatsappSameAsPhone}
                                                onCheckedChange={(checked) => setWhatsappSameAsPhone(checked as boolean)}
                                            />
                                            <Label
                                                htmlFor="whatsapp-same-mobile"
                                                className="text-sm font-normal cursor-pointer"
                                            >
                                                My WhatsApp number is the same as my phone number
                                            </Label>
                                        ...
                                        {!whatsappSameAsPhone && (
                                            <div className="space-y-2">
                                                <Label htmlFor="whatsapp-mobile">WhatsApp Number</Label>
                                                <Input
                                                    id="whatsapp-mobile"
                                                    type="tel"
                                                    value={customerWhatsapp}
                                    ...
                                    {/* Special Requirements */}
                                    <div className="space-y-2">
                                        <Label htmlFor="requirements-mobile">
                                            Your Requirements *
                                        </Label>
                                        <Textarea
                                            id="requirements-mobile"
                                            value={specialRequirements}
                                            onChange={(e) => setSpecialRequirements(e.target.value)}
                                            placeholder="Tell us about your requirements:&#10;• Any dietary restrictions?&#10;• Accessibility needs?&#10;• Accommodation preferences?&#10;• Activities you're interested in?&#10;• Any other special requests?"
                                            rows={6}
