...
export function BookingsList({ bookings }: BookingsListProps) {
    ...
    const filteredBookings = bookings.filter((booking) => {
        ...
        if (selectedFilter === "completed" && !isCompleted(booking)) return false;
                ...
                <div className="flex flex-col items-center gap-4 max-w-md mx-auto">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mb-6">
                            Start exploring tours and request quotes to book your adventure
                        </p>
                    </div>
    ...
    const getEmptyStateMessage = () => {
        switch (selectedFilter) {
            ...
            case "needs_action":
                return "No bookings need your attention. Great!";
            case "completed":
                return "No completed tours yet.";
            case "disputed":
            ...
            <Card className="p-4">
                <div className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            placeholder="Search by reference or tour name..."
                            value={searchQuery}
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            <p className="font-semibold text-orange-900">
                                {statusCounts.needs_action} booking{statusCounts.needs_action !== 1 ? "s" : ""} need{statusCounts.needs_action === 1 ? "s" : ""} confirmation!
                            </p>
                            <p className="text-sm text-orange-700">
                                Review and confirm tour completion.
                            </p>
                        </div>
                        <Button
                            size="sm"
